...
public abstract class BaseRecordsFile {
  ...
  protected void addEntryToIndex(String key, RecordHeader newRecord, int currentNumRecords) throws IOException, RecordsFileException {
    DbByteArrayOutputStream keybuffer = new DbByteArrayOutputStream(MAX_KEY_LENGTH);
   ...
   */
	public synchronized void deleteRecord(String key)
		...
		deleteEntryFromIndex(key, delRec, currentNumRecords); // TODO crash order this needs to come first
	}
